...
export async function GET(request: Request) {
  ...
  const { data, error } = await supabase
    ...
    .select(
      'id,email,first_name,last_name,phone,attending,guest_count,guest_names,dietary_restrictions,notes,invite_code,household_name,mailing_address,thank_you_status,created_at,updated_at'
    )
