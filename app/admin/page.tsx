      ...
      <div className="max-w-6xl mx-auto">
        ...
        {summary && (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-8">
            <div className="bg-white p-4 rounded-lg shadow-sm text-center"><p className="text-2xl font-bold">{summary.total_responses}</p><p className="text-xs text-accent/60">Responses</p></div>
            <div className="bg-white p-4 rounded-lg shadow-sm text-center"><p className="text-2xl font-bold text-green-600">{summary.attending_parties}</p><p className="text-xs text-accent/60">Attending</p></div>
            <div className="bg-white p-4 rounded-lg shadow-sm text-center"><p className="text-2xl font-bold text-red-500">{summary.declined_parties}</p><p className="text-xs text-accent/60">Declined</p></div>
            <div className="bg-white p-4 rounded-lg shadow-sm text-center"><p className="text-2xl font-bold text-primary">{summary.total_guests}</p><p className="text-xs text-accent/60">Total Heads</p></div>
            <div className="bg-white p-4 rounded-lg shadow-sm text-center"><p className="text-2xl font-bold">{summary.friday_hotel}</p><p className="text-xs text-accent/60">Fri Rooms</p></div>
            <div className="bg-white p-4 rounded-lg shadow-sm text-center"><p className="text-2xl font-bold">{summary.saturday_hotel}</p><p className="text-xs text-accent/60">Sat Rooms</p></div>
          </div>
        )}
